...
import { CalendarDays, Eye, Tags, MessageSquare } from "lucide-react";
        ...
        <article className="max-w-4xl mx-auto px-4 md:px-8 lg:px-12 rounded-3xl bg-secondary/40 backdrop-blur-2xl border border-secondary/50 shadow-[0_0_30px_rgba(0,255,255,0.15)]">
          ...
          <section id="comments" className="max-w-3xl mx-auto py-8 mt-6">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-2xl font-bold text-foreground drop-shadow-[0_0_8px_var(--primary-rgb,0_255_255_/_0.3)]">
            ...
            {comments && comments.length > 0 ? (
              ...
              <div className="text-center py-6 mb-8 text-foreground/60 bg-secondary/20 rounded-xl border border-secondary/50">
                <p>هنوز دیدگاهی برای این پست ثبت نشده است. اولین نفر باشید!</p>
              </div>
            )}

            <div>
              <h3 className="text-lg font-semibold mb-4 text-foreground/90 drop-shadow-[0_0_8px_var(--primary-rgb,0_255_255_/_0.2)]">
